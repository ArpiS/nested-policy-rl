...
'''
def fqi(verbose=True, is_contrastive=False, epoch=1000, init_experience=200, evaluations=5, force_left=5, random_seed=None):
...
nfq_agent
    Training agent, can access the model using nfq_agent._nfq_net.
'''
def warm_start(verbose=True, epoch=1000, init_experience=200, evaluations=5, force_left=5, random_seed=None):
    # Setup environment
    bg_cart_mass = 1.0
    fg_cart_mass = 1.0
...
nfq_agent
    Training agent, can access the model using nfq_agent._nfq_net.
'''
def transfer_learning(verbose=True, epoch=3000, init_experience=200, evaluations=5, force_left=5, random_seed=None):
    bg_cart_mass = 1.0
    fg_cart_mass = 1.0
    is_contrastive = False
