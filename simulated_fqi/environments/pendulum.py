...
class PendulumEnv(gym.Env):
    ...
    def __init__(self, g=10.0, m=1., max_steps=100, group=1, mode="train"):
        self.max_speed = 8
        self.max_torque = 2.
        self.dt = .05
        self.g = g
    ...
    def generate_rollout(
        self, get_best_action: Callable = None, render: bool = False, rollout_length: int = 50, group: int = 1
        ...
        for ii in range(rollout_length):
            ...
            rollout.append((obs.squeeze(), action, cost, next_obs.squeeze(), done, group))
            episode_cost += cost
            obs = next_obs
            # import ipdb; ipdb.set_trace()
